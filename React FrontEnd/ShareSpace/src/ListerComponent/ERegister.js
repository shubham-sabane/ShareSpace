...
export default function ERegister() {
  ...
  let [EmpDetails,setEmpDetails] = useState({firstName:"",lastName:"",userName:"",password:""});
  let addEmp=(event)=>{
    event.preventDefault();
    EmployerService.addEmp(EmpDetails)
    .then((result) => {
      setEmpDetails({firstName:"",lastName:"",userName:"",password:""});
      navigate("/login")
    })
    .catch();
  }
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input
                        ...
                        onChange={(event)=>{setEmpDetails({...EmpDetails,firstName:event.target.value})}}
                        required
                      />
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input
                        ...
                        onChange={(event) =>{setEmpDetails({...EmpDetails,lastName:event.target.value})}}
                        required
                      />
                      <label className="form-label" htmlFor="form3Example1c">
                        Last Name
